...
public class LectorExcel {
    ...
    private void GENERAR_XLSX(String Nombre_Archivo, List Lista_Datos_Celda) {
        try {
            ...
            XSSFSheet Hoja_hssf = Libro_trabajo.getSheet("INDICE");
            /**
             *
    ...
    public static void main(String[] args) {
        ...
        System.out.println(fileName);
         String documentoDir="/home/nico/Trabajo/Lubricentro/Excel/clientes.xlsx";

        new LectorExcel().Leer_Archivo_Excel(documentoDir);
    }
}