...
public class TareaImportarExcel extends JPanel
    ...
    public TareaImportarExcel() {
        ...
        private void importarExcelProveedores() throws FileNotFoundException, IOException {
            ...
            workbook = new HSSFWorkbook(new FileInputStream("/home/nico/Trabajo/Lubricentro/Excel/PROVEEDOR.xls"));
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        if ("progress" == evt.getPropertyName()) {
            ...
            taskOutput.append(String.format(
                    "Completado %d%% de importacion de datos.\n", task.getProgress()));
        } 
    }
    ...
    private static void createAndShowGUI() {
        ...
        JComponent newContentPane = new TareaImportarExcel();
